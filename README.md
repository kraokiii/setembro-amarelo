# 💛 Setembro Amarelo — Aplicação Web de Apoio Emocional e Conscientização
...
Aplicação web interativa, responsiva e empática desenvolvida para a atividade prática em alusão ao **Setembro Amarelo** (mês de prevenção ao suicídio e valorização da vida).

---

## 🎯 Objetivo do Projeto

Desenvolver uma página web acessível e acolhedora com recursos interativos de suporte emocional, direcionamento rápido para atendimento de emergência (CVV) e informações sobre onde encontrar ajuda especializada na rede de saúde pública e comunitária.
...
* **CSS3:** Estilização responsiva com CSS Grid, Flexbox e animações `@keyframes`.
* **JavaScript (ES6+):** Lógica interativa, manipulação de DOM, síntese de áudio (Web Audio API) e interatividade do temporizador de respiração.

---

## 🌐 Como Acessar a Aplicação

A aplicação está publicada e funcional através do **GitHub Pages**:

👉 **[Acesse o Site Aqui](https://kraokiii.github.io/setembro-amarelo/)** 
